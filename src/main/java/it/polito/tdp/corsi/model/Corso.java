...
public class Corso {
	//guardo nel database che attributi ha
	...
	//quando si parla di classi che modellano il database, bisogna rimodellare hashCode ed equals della chiave primaria della classe
	@Override
	public int hashCode() {
		final int prime = 31;
		int result = 1;
